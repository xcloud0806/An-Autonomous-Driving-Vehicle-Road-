...
def segment_night_data(day_seg_dir, night_gnss_path):
    ...
    for seg_name, day_gnss_info in tqdm(day_seg_gnss_info.items(), ncols=150):
        ...
        # 结果
        segment_results_list.append([night_ts_list[start_id], night_ts_list[end_id], trajectory_dis, seg_name])
        ...
        save_path = f'./test/trajectory_{seg_name}.jpg'
...
if __name__ == '__main__':
    day_seg_dir = '/data_cold2/ripples/sihao_1482/common_seg/20240417_d/'
    night_gnss_path = '/data_cold2/ripples/sihao_1482/common_frame/20240417_n/20240417-20-31-50/gnss.csv'
    print(segment_night_data(day_seg_dir, night_gnss_path))
